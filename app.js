...
function renderDashboard() {
  ...
  $("#dashboard").innerHTML = `
    ...
    <div class="card">
      ...
      <div class="table-wrap"><table><thead><tr><th>Produit</th><th>Jours saisis</th><th>% conformité</th><th>Jours non conformes</th><th>Réf. hebdo utilisée</th><th>Résultat semaine</th><th>Statut</th></tr></thead><tbody>
...
function dayResultHtml(c) {
  ...
  if (c.resultat === "Bonus") return `<span class="badge badge-bonus">Bonus</span>`;
  if (c.resultat === "Malus") return `<span class="badge badge-malus">Malus</span>`;
  if (c.resultat === "Neutre") return `<span class="badge badge-neutre">Neutre</span>`;
  if (c.resultat === "Débloqué admin") return `<span class="badge badge-warn">Débloqué admin</span>`;
    ...
    for (const product of products) {
      ...
      cards.push(`<article class="mobile-saisie-card">
        ...
        <div class="mobile-fields">
          ...
          <div class="mobile-field mobile-wide"><label>Résultat</label><div class="readonly-value" data-live-result="${key}">${dayResultHtml(c)}</div></div>
...
function renderSynthese() {
  ...
  $("#synthese").innerHTML = `
    ...
    <div class="card">
      ...
      <div class="table-wrap"><table><thead><tr><th>Produit</th><th>Qté réf.</th><th>Rendement réf.</th>${DAYS.map(d => `<th>${d.name}</th>`).join("")}<th>Réf. hebdo utilisée</th><th>Jours non conformes</th><th>Commentaire semaine</th><th>Bonus/Malus final</th><th>Produit quantifié</th><th>QTE travaillée</th><th>QTE bonus/malus</th><th>€</th><th>Commentaire synthèse</th></tr></thead><tbody>
      ${summary.map(p => `<tr>
