    ...
    <div class="card">
      <div class="card-header">
        <div>
          ...
          <p class="muted">Analyse privée Admin principal : semaine X à semaine Y, bonus, malus, semaines absentes de rendement, semaines non validées et pièces non conformes.</p>
        </div>
      ...
      <div id="analyseResults" class="analyse-results note-box">Choisis les semaines puis clique sur Analyser.</div>
    </div>`;
...
function requiredDaysForWeek(weekStart) {
  // Jours attendus pour le contrôle : jours de l'application, hors jours fériés français.
  return DAYS.filter(d => !holidayName(dateForDay(weekStart, d.index)));
}
